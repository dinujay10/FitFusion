...
class Instructorapplygym {
    use Controller;

    public function index() {
        $data = [];
        $insdetails=new Instructordetails;
        $insbanck=new Instructorbanckaccount;
        $insspecialization=new Instructorspecialization;
        $insqualification=new Instructorqualification;
...
/////////////////////////////////////////////////            
        //    foreach ($_FILES['images']['tmp_name'] as $key => $tmp_name) {
                ...
                if($error===0){
                    if($img_size>325000){
                        ...
                        if(in_array($img_ex_lc,$allowed_exs)){
                            ...
                            $img_upload_path='C:/xa/htdocs/FitFusion/public/assets/uploadinstructorimages/'.$new_img_name;
           ...
           //insert banck details
            ...
            $temp=["pilates","yoga","bodybuilding","athletic","aerobics","weight lifting"];
            foreach($temp as $x){
                if(isset($_POST[$x])){
                    $specialization['iemail']=$_SESSION['email'];
                ...
                if($error===0){
                    if($file_size>125000){
                        ...
                        if(in_array($file_ex_lc,$allowed_exs)){
                            ...
                            $file_upload_path='C:/xa/htdocs/FitFusion/public/assets/instructorcertificates/'.$new_file_name;
                            move_uploaded_file($tmp_name,$file_upload_path);

                            $certifiactes['iemail']=$_SESSION['email'];
        ...
        $this->view('instructorapplygym',$data);
    }
