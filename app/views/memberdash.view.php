...
<body>
    <div class="side-menu">
        ...
        <!-- <img src="<?=ROOT?>/assets/images/dashboards/dashboard (2).png" alt="">&nbsp; -->
            ...
            <li><img src="<?=ROOT?>/assets/images/dashboards/progress.jpeg" alt="">&nbsp;<h6>My Progress</h6> </li>
            <li><img src="<?=ROOT?>/assets/images/dashboards/task list.jpeg" alt="">&nbsp;<h6>Task List</h6> </li>
            <li><img src="<?=ROOT?>/assets/images/dashboards/meeting.jpeg" alt="">&nbsp;<h6>Meetings</h6> </li>
            <li><img src="<?=ROOT?>/assets/images/dashboards/help.jpeg" alt="">&nbsp; <h6>Help</h6></li>
            <a href="complaintc"><li><img src="<?=ROOT?>/assets/images/dashboards/setting.png" alt="">&nbsp;<h6>complaints</h6> </li></a>
        </ul>
    </div>
    <div class="container">
        <div class="header">
            <div class="nav">
                <div class="search">
                    ...
                    <button type="submit"><img src="<?=ROOT?>/assets/images/dashboards/search.png" alt=""></button>
                </div>
                <div class="user">
                    <a href="#" class="btn">Add New</a>
                    <img src="<?=ROOT?>/assets/images/dashboards/notifications.png" alt="">
                    <div class="img-case">
