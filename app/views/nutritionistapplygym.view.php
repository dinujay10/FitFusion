      ...
      <form  method="POST" enctype="multipart/form-data">
        ...
        <div class="user-input-box">
            ...
            <div class="specialization">
                ...
                <label for="CNS"> CNS</label><br>
                <input type="checkbox" id="RDN" name="RDN" value="RDN">
                <label for="RDN"> RDN</label><br>
                <input type="checkbox" id="BCHN" name="BCHN" value="BCHN">
                <label for="BCHN"> BCHN</label><br>     
                <input type="checkbox" id="CNC" name="CNC" value="CNC">
                <label for="CNC"> CNC</label><br>
            </div>
          </div>
