    ...
    <body>
        ...
        <form method="POST">
            <div class="add-manager-container">
                <div class="box"><h2>Add Manager</h2></div>
                ...
                <div class="box"><input type="submit" value="Add Manager"></div>
            </div>
        </form>
                    ...
                    // if(!empty($data)){
                        for($x=0;$x<count($data);$x++){
                            ...
                            <td>
                                ...
                                <button><a href="addgymmanager?deletemanager='.$email.'">Remove</a></button>
                            </td>
                            <br>
                        </tr> ';
                        }
